package com.jinshan.application.base;
   ...
   // private LoadingDailog loadingDailog;
    ...
    public void setContentView(int layoutResId) {
        ...
        if (null != mToolbar) {
            ...
            mToolbar.setNavigationIcon(R.drawable.tab_back);
    ...
    public void showError(String msg) {
        ...
        toggleShowEmpty(true, msg, R.drawable.logo_empty, new View.OnClickListener() {
            @Override
    ...
    public void showNormal() {
        toggleShowEmpty(true, getString(R.string.no_data), R.drawable.logo_empty, new View
                .OnClickListener() {
            @Override
            public void onClick(View view) {
                onClickReload();
