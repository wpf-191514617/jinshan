...
public class WebActivity extends BaseActivity {
    ...
    protected void initViewAndData() {
        ...
        webLayout.getWebView().getSettings().setUseWideViewPort(true);
        webLayout.getWebView().getSettings().setLoadWithOverviewMode(true);

       // webLayout.getWebView().getSettings().setSupportZoom(true); //将图片调整到适合webview的大小
        webLayout.getWebView().getSettings().setTextZoom(120);// 缩放至屏幕的大小
