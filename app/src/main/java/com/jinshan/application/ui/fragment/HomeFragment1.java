                ...
                case 2:
                    ...
                    helper.setText(R.id.tvPost , resultlistBean.getTitle())
                           .setText(R.id.tvPostTime , String.valueOf(resultlistBean.getCreateTime()))
                            .setText(R.id.tvPostCount , String.valueOf(resultlistBean.getClickNum()));


                    if (StringUtils.isEmpty(resultlistBean.getCreateTime())){
                        helper.setText(R.id.tvPostTime , "");
                    } else {
                        String date = resultlistBean.getCreateTime();
                        date = TimeUtil.timeStamp2Date(Long.parseLong(date) , "yyyy-MM-dd");
                        helper.setText(R.id.tvPostTime , date);
                    }
